...
export async function POST(req: NextRequest) {
  ...
  // Sem mês/ano → conjunto GERAL (month=0/year=0): posição atual do estoque no relatório
  // único de Produtos; cada envio substitui o anterior. Mês/ano continuam aceitos.
